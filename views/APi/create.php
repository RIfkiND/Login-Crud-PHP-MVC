                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="id_post" value="<?php echo $id_post; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Post" value="">
                               
                            </div>

                            <div class="form-group">
                                <label class="font-weight-bold">KONTEN</label>
                                <textarea class="form-control" name="deskripsi" id="content" rows="5" placeholder="Masukkan Deskripsi Post"></textarea>
